...
while($rw=mysqli_fetch_object($facilitys->result)){
...
while($rw=mysqli_fetch_object($persons->result)){
...
while($rw=mysqli_fetch_object($personshedules->result)){
...
$groupby="";
$orderby="";
$employees->retrieve($fields,$join,$where,$having,$groupby,$orderby);echo $employees->sql;echo mysqli_error();
...
while($rw=mysqli_fetch_object($employees->result)){
...
while($rw=mysqli_fetch_object($ratings->result)){
